...
## Project Structure
    ...
    ├── feature_prd_shiva_a_37403  # Django project configurations
...
1. Clone this repo and `cd feature_prd_shiva_a_37403`
...
2. Clone this repo and `cd feature_prd_shiva_a_37403`
